...
{#if hsnTotals.length > 0}
    <div class="bg-gray-100 p-4 mb-4 border rounded">
        <!-- title -->
        <div class="grid grid-cols-5 gap-2 mb-2 bg-blue-200 p-2">
            <div>HSN</div>
            <div>GST</div>
        ...
        <!-- rows -->
        {#each hsnTotals as [hsn, { gst, rate, quantity }]}
            <div class="grid grid-cols-5 gap-2 mb-4 border-b odd:bg-gray-100">
